...
-  Armazenar os dados em arquivo (pode ser aberto no Excel)
...
- Manipulação de arquivos (FileReader, FileWriter, BufferedReader)  
- Listas (ArrayList)  
- Estrutura de menus e entrada de dados pelo console  
